        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DepartmentId = table.Column<int>(type: "int", nullable: false),
                    GenderCode = table.Column<string>(type: "nvarchar(1)", maxLength: 1, nullable: true),
                    PositionId = table.Column<int>(type: "int", nullable: false),
                    ReportedToEmployeeNumber = table.Column<string>(type: "nvarchar(6)", nullable: true),
                    VacationDaysLeft = table.Column<int>(type: "int", nullable: false, defaultValue: 24),
                    Salary = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Employees", x => x.EmployeeNumber);
                    table.CheckConstraint("CK_Employee_VacationDaysLeft", "[VacationDaysLeft] <= 24");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApprovedByEmployeeNumber = table.Column<string>(type: "nvarchar(6)", nullable: true),
                    DeclinedByEmployeeNumber = table.Column<string>(type: "nvarchar(6)", nullable: true),
